    ...
    <div className="min-h-screen flex flex-col bg-background overflow-x-hidden">
      ...
      <main className="flex-grow overflow-x-hidden">
        ...
        <section className="relative overflow-hidden border-b border-border/20" style={{
          ...
          <div className="container px-4 py-16 sm:py-20 md:py-24 lg:py-32 relative z-10 max-w-full">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl md:text-xl lg:text-2xl text-gray-700 mb-3 sm:mb-4 max-w-3xl mx-auto leading-relaxed px-2">
                A Minimalist, Handcrafted Software Ecosystem
              </p>
              
              <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-8 sm:mb-10 md:mb-12 max-w-4xl mx-auto leading-relaxed px-2">
        ...
        <section className="py-16 sm:py-20 bg-background overflow-hidden">
          <div className="container px-4 max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-pixel mb-4 sm:mb-6 text-foreground px-2 break-words">The FernKit Philosophy</h2>
        ...
        <section className="py-16 sm:py-20 bg-background overflow-hidden">
          <div className="container px-4 max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-pixel mb-4 sm:mb-6 text-foreground px-2">Core Repositories</h2>
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <section className="py-16 sm:py-20 bg-background overflow-hidden">
          <div className="container px-4 max-w-4xl mx-auto">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-pixel mb-4 sm:mb-6 text-foreground px-2 break-words">Ready to Build Something Amazing?</h2>
              <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed text-muted-foreground px-4 max-w-3xl mx-auto">
